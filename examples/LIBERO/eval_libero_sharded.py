...
def eval_libero(args: Args) -> None:
    ...
    avg_successful_completion_steps = (
        float(np.mean(successful_completion_steps)) if successful_completion_steps else None
    )
    if avg_successful_completion_steps is not None:
        logging.info(
    ...
    summary = {
        ...
        "task_end": task_range.stop,
        "task_step": task_range.step,
        "task_ids": list(task_range),
        "total_episodes": total_episodes,
        "total_successes": total_successes,
        "success_rate": float(total_successes) / float(total_episodes),
        "avg_successful_completion_steps": avg_successful_completion_steps,
        "successful_completion_steps": successful_completion_steps,
        "tasks": task_results,
    }
    summary_path = pathlib.Path(args.video_out_path) / "result_summary.json"
